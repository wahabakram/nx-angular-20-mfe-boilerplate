...
class AngularNodeViewRendererClass extends NodeView<
...
> {
  ...
  override mount() {
    ...
    const props: NodeViewProps = {
      editor: this.editor,
      node: this.node,
      // @ts-expect-error decorations type mismatch
...
export const AngularNodeViewRenderer = (
  ...
  // @ts-expect-error TS2345 - Type 'Partial<AngularNodeViewRendererOptions>' is not assignable to type 'AngularNodeViewRendererOptions'.
  return (props: NodeViewRendererProps) => {
    return new AngularNodeViewRendererClass(ViewComponent, props, options);
  };
};
