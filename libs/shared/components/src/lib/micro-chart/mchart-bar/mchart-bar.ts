...
@Component({
  selector: 'mf-mchart-bar',
  exportAs: 'mfMchartBar',
    ...
    fromEvent<MouseEvent>(this._document, 'mousemove')
      ...
      .subscribe((e: MouseEvent) => {
        ...
        if (
          ...
          if (
            !target.closest('.mf-mchart-line') ||
            !target.classList.contains('mf-mchart-tooltip-overlay') ||
            !target.closest('.mf-mchart-tooltip-overlay')
          ) {
            oldX = null;
            this._overlayRef?.detach();
          }
