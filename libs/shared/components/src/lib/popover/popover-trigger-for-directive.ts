...
@Directive({
  selector: '[mfPopoverTriggerFor]',
  exportAs: 'mfPopoverTriggerFor',
  host: {
    'class': 'mf-popover-trigger-for',
    '[class.mf-popover-trigger-for--is-open]': 'api.isOpen()',
    '(click)': '_handleClick()',
