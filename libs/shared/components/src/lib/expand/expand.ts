...
export class Expand {
  ...
  constructor() {
    effect(() => {
      ...
      (this._elementRef.nativeElement as HTMLElement).style.setProperty('--mf-expand-fade-color', this.color(), 'important');
      (this._elementRef.nativeElement as HTMLElement).style.setProperty('--mf-expand-expanded-height', this.height(), 'important');
    });
  }
