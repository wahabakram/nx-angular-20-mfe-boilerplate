...
@Component({
  selector: 'mf-splash-screen',
  exportAs: 'mfSplashScreen',
  imports: [],
  templateUrl: './splash-screen.html',
  styleUrl: './splash-screen.scss',
  host: {
    'class': 'mf-splash-screen',
  }
})
export class SplashScreen {
  ...
  ngOnInit() {
    this._renderer.setProperty(
      this._elementRef.nativeElement, '--mf-splash-screen-hide-animation-duration', (this.animationDuration() / 1000) + 's'
    );
  }
