...
@Directive({
  selector: '[mfColorPickerTriggerFor]',
  exportAs: 'mfColorPickerTriggerFor',
  host: {
    'class': 'mf-color-picker-trigger-for',
...
export class ColorPickerTriggerForDirective implements OnDestroy{
  ...
  private _getOverlayConfig() {
    return new OverlayConfig({
      ...
      panelClass: 'mf-color-picker-overlay-panel'
    });
  }
