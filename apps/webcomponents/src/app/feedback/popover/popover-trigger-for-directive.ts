...
import { PopoverTrigger, PopoverPosition, POPOVER_TRIGGER } from './popover.properties';
import { PositionManager } from './position-manager';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';

@Directive({
  selector: '[mfcPopoverTriggerFor]',
  exportAs: 'mfcPopoverTriggerFor',
  host: {
    'class': 'mfc-popover-trigger-for',
    '[class.mfc-popover-trigger-for--is-open]': 'api.isOpen()',
    '(click)': '_handleClick()',
