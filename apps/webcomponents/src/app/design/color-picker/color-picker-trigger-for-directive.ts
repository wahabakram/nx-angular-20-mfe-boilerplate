...
@Directive({
  selector: '[mfcColorPickerTriggerFor]',
  exportAs: 'mfcColorPickerTriggerFor',
  host: {
    'class': 'mfc-color-picker-trigger-for',
...
export class ColorPickerTriggerForDirective implements OnDestroy{
  ...
  colorPickerTemplateRef = input.required<TemplateRef<any>>({
    alias: 'mfcColorPickerTriggerFor'
  });
  ...
  private _getOverlayConfig() {
    return new OverlayConfig({
      ...
      panelClass: 'mfc-color-picker-overlay-panel'
    });
  }
