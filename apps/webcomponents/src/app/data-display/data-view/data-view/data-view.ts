...
import { DataViewEmptyDataDirective } from '../data-view-empty-data';
import { DataViewEmptyFilterResultsDirective } from '../data-view-empty-filter-results';
import { DataViewActionBarDirective } from '../data-view-action-bar/data-view-action-bar';

@Component({
  selector: 'mfc-data-view',
  exportAs: 'mfcDataView',
  imports: [
    MatCell,
    MatCheckbox,
    MatColumnDef,
...
export class DataView<T> implements OnInit, DataViewType {
