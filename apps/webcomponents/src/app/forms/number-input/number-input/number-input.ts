...
@Component({
  selector: 'mfc-number-input',
  exportAs: 'mfcNumberInput',
  imports: [
    MatRipple,
    NgTemplateOutlet
  ],
  ...
  host: {
    'class': 'mfc-number-input',
    '[class.floating]': 'shouldLabelFloat',
    'id': 'id'
  }
})
export class NumberInput implements MatFormFieldControl<any>, ControlValueAccessor, OnDestroy, DoCheck {
  ...
  get id(): string {
    return `mfc-number-input${NumberInput.nextId++}`;
  }
  ...
  isDecreaseDisabled() {
    ...
    // @ts-expect-error ignore this.min() type check
  ...
  isIncreaseDisabled() {
    ...
    // @ts-expect-error ignore this.max() type check
