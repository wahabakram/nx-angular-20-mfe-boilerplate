...
@Component({
  selector: 'mfc-timezone-select',
  exportAs: 'mfcTimezoneSelect',
  imports: [
    MatSelect,
    MatOption,
    FormsModule,
...
export class TimezoneSelect implements OnInit, MatFormFieldControl<any>, ControlValueAccessor {
  ...
  readonly controlType = 'mfc-timezone-select';
  readonly id = `mfc-timezone-select-${nextId++}`;
