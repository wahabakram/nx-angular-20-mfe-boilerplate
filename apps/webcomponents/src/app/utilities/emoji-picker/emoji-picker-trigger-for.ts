...
import { PopoverPosition, PositionManager } from '../../feedback/popover';
import {
  ConnectedPosition,
...
@Directive({
  selector: '[mfcEmojiPickerTriggerFor]',
  exportAs: 'mfcEmojiPickerTriggerFor',
  host: {
...
export class EmojiPickerTriggerForDirective {
  ...
  for = input.required<TemplateRef<any>>({
    alias: 'mfcEmojiPickerTriggerFor'
  });
