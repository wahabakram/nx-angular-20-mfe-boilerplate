...
import { AutoFocusDirective, FocusElementDirective, MenuOptionGroupDirective } from '../../core/directives';

@Component({
  selector: 'mfc-filter-builder',
  exportAs: 'mfcFilterBuilder',
  imports: [
    MatIcon,
    MatMenuTrigger,
    MatMenu,
