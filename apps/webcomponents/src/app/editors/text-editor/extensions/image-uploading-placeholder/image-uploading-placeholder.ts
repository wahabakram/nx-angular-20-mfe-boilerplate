...
@Component({
  selector: 'mfc-image-uploading-placeholder',
  exportAs: 'mfcTextEditorUploadingPlaceholder',
  imports: [MatProgressSpinner],
  templateUrl: './image-uploading-placeholder.html',
  styleUrl: './image-uploading-placeholder.scss',
  host: {
    class: 'mfc-image-uploading-placeholder',
    '[class.selected]': 'selected',
  },
})
export class ImageUploadingPlaceholder
  extends AngularNodeView
